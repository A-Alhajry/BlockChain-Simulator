...
public class VerifyRequestScreen extends AbstractScreen {
	...
	public VerifyRequestScreen() {
		super();
		//super.setVisible(true);
		
		try {
			headerLabel = new JLabel("New Verification Request");
	...
	private void setEvents() throws Exception {
		...
		fileButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				int fileDialogReturn = fileDialog.showOpenDialog(VerifyRequestScreen.this);
		...
		enterprisesList.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				...
				if (selectedEnterprise.getId() != null) {
					services = controller.getVerifyServices(selectedEnterprise.getId());
				}
		...
		servicesList.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				...
				if (selectedService != null) {
					...
					FileNameExtensionFilter filter = new FileNameExtensionFilter("Allowed Files : " + ".atts", "atts");
		...
		submitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					VerifyRequestScreen screen = VerifyRequestScreen.this;
					...
					String password = JOptionPane.showInputDialog(VerifyRequestScreen.this, "Please Enter Your Password");
					//String password = "mypassword";

					controller.createVerifyRequest(password, selectedEnterprise.getId(), selectedService.getId(), filePath.getAbsolutePath(), comments);
					VerifyRequestScreen.this.showDialog("Success", "Request Successfully Submitted", JOptionPane.INFORMATION_MESSAGE);
					ViewsManager.showClientVerifyRequests();
				}
				
				catch (Exception ex) {
					JOptionPane.showMessageDialog(VerifyRequestScreen.this, "Error Occurred, Please View Logs", "Error Occurred", JOptionPane.ERROR_MESSAGE);
				}
