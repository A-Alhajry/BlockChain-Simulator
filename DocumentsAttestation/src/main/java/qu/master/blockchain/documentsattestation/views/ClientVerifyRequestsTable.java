...
public class ClientVerifyRequestsTable extends JTable {
	...
	private Consumer<VerifyRequest> saveAction;
	
	public ClientVerifyRequestsTable(List<VerifyRequest> requests, Consumer<VerifyRequest> saveAction, Consumer<VerifyRequest> signsAction) {
...
//	
	...
	public TableCellRenderer getCellRenderer(int row, int col) {
		return new ClientSignRequestsTableRenderer(statusCol, saveCol);
	}
	...
	private void setEvents() {
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent ev) {
				...
				int col = ClientVerifyRequestsTable.this.columnAtPoint(ev.getPoint());
				VerifyRequest req = requests.get(row);
	...
	private static Object[] getCols() {
		Object[] cols = new String[] { "Organization", "Service", "Date", "Signatures", "Status"};
		return cols;
	}

	private static Object[][] getRows(List<VerifyRequest> requests) {
...
class ClientVerifyRequestsTableRenderer extends JPanel implements TableCellRenderer {

	private int statusCol;
	private int saveCol;

	public ClientVerifyRequestsTableRenderer(int statusCol, int saveCol) {
