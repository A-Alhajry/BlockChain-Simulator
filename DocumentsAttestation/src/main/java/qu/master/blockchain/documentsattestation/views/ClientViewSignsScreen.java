...
public class ClientViewSignsScreen extends AbstractScreen {
	...
	public ClientViewSignsScreen() {
		super();
		headerLabel = new JLabel("View Signature Requests");
	...
	public void initScreen() {
		removeAll();
		requests = controller.getClientSignRequests();
		...
		ClientSignRequestsTable table = new ClientSignRequestsTable(requests, ((SignRequest req) -> onClickSave(req)), ((SignRequest req) -> onClickSigns(req)));
	...
	private void onClickSave(SignRequest req) {
		try {
	...
	private String[][] getRows(List<SignRequest> requests) {
