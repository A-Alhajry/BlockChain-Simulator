...
Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('c38169f6-d514-4ab7-9176-2fd56426ea72', '8bdb2178-8484-4fde-a4b1-d2e7fcacb771', 'Graduation Statement', '', 'pdf');
Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('e44bcd93-d10f-4a6e-982b-b54bdd2fcf49', '8bdb2178-8484-4fde-a4b1-d2e7fcacb771', 'Academic Transcript', '', 'pdf');
Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('795c538d-438a-4a22-96f4-2ff440e74364', '8bdb2178-8484-4fde-a4b1-d2e7fcacb771', 'Degree Evaluation', '', 'pdf');

Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('a89f08dc-dbc1-48b6-94ac-a41e62298fbe', '16f1fd8b-b80b-43e4-9e27-9aa78b7f6a5f', 'Birth Certificate', '', 'pdf');
Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('e122ddeb-e086-4d9e-b2e4-c41847ca9c6f', '16f1fd8b-b80b-43e4-9e27-9aa78b7f6a5f', 'Job Certificate', '', 'pdf');

Insert Into EnterpriseService(id, enterprise_id, title, desc, supported_files) Values('ffc156fe-7fc1-4f51-8e22-63dd67a9c98a', '3771af1f-28d2-4734-952e-71031f15cc9d', 'Certificate Of Good Conduct', '', 'pdf');
