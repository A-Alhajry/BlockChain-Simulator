...
<html lang="en">
	...
	<head>
		...
		<link href="${theme}/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />

		<!--end::Page Vendors Styles -->

		<!--begin:: Global Mandatory Vendors -->
		<link href="${theme}/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" type="text/css" />

		<!--end:: Global Mandatory Vendors -->

		<!--begin:: Global Optional Vendors -->
		<link href="${theme}/tether/dist/css/tether.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-datetime-picker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/select2/dist/css/select2.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/nouislider/distribute/nouislider.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/owl.carousel/dist/assets/owl.carousel.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/owl.carousel/dist/assets/owl.theme.default.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/summernote/dist/summernote.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/animate.css/animate.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/toastr/build/toastr.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/morris.js/morris.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/sweetalert2/dist/sweetalert2.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/socicon/css/socicon.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/vendors/line-awesome/css/line-awesome.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/vendors/flaticon/flaticon.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/vendors/flaticon2/flaticon.css" rel="stylesheet" type="text/css" />
		<link href="${theme}/vendors/fontawesome5/css/all.min.css" rel="stylesheet" type="text/css" />

		<!--end:: Global Optional Vendors -->

		<!--begin::Global Theme Styles(used by all pages) -->
		<link href="${theme}/demo/demo2/base/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-page--loading-enabled kt-page--loading kt-page--fixed kt-header--fixed kt-header--minimize-topbar kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="index.html">
					<img alt="Logo" src="${theme}/media/logos/logo-2-sm.png" />
				</a>
			</div>
							...
							<div class="kt-container">
								...
								<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
									<div class="kt-header__brand-logo">
										<a href="index.html">
											<img alt="Logo" src="${theme}/media/logos/logo-2.png" class="kt-header__brand-logo-default" />
											<img alt="Logo" src="${theme}/media/logos/logo-2-sm.png" class="kt-header__brand-logo-sticky" />
										</a>
									</div>
								...
								<div class="kt-header__topbar">
									...
									<div class="kt-header__topbar-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
											<form>
												...
												<!-- begin:: Mycart -->
												<div class="kt-mycart">
													<div class="kt-mycart__head kt-head" style="background-image: url(${theme}/media/misc/bg-1.jpg);">
														...
														<div class="kt-mycart__item">
															<div class="kt-mycart__container">
																...
																<a href="#" class="kt-mycart__pic">
																	<img src="${theme}/media/products/product9.jpg" title="">
																</a>
															</div>
														</div>
														<div class="kt-mycart__item">
															<div class="kt-mycart__container">
																...
																<a href="#" class="kt-mycart__pic">
																	<img src="${theme}/media/products/product13.jpg" title="">
																</a>
															</div>
														</div>
														<div class="kt-mycart__item">
															<div class="kt-mycart__container">
																...
																<a href="#" class="kt-mycart__pic">
																	<img src="${theme}/media/products/product16.jpg" title="">
																</a>
															</div>
														</div>
														<div class="kt-mycart__item">
															<div class="kt-mycart__container">
																...
																<a href="#" class="kt-mycart__pic">
																	<img src="${theme}/media/products/product15.jpg" title="" alt="">
																</a>
															</div>
														</div>
													</div>
									...
									<div class="kt-header__topbar-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
											<form>
												...
												<!--begin: Head -->
												<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(${theme}/media/misc/bg-1.jpg)">
									...
									<div class="kt-header__topbar-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
											<form>
												...
												<!--begin: Head -->
												<div class="kt-head kt-head--skin-dark" style="background-image: url(${theme}/media/misc/bg-1.jpg)">
													<h3 class="kt-head__title">
														User Quick Actions
									...
									<div class="kt-header__topbar-item kt-header__topbar-item--langs">
										<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,10px">
											<span class="kt-header__topbar-icon">
												<img class="" src="${theme}/media/flags/012-uk.svg" alt="" />
											</span>
										</div>
											...
											<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
												<li class="kt-nav__item kt-nav__item--active">
													<a href="#" class="kt-nav__link">
														<span class="kt-nav__link-icon"><img src="${theme}/media/flags/020-flag.svg" alt="" /></span>
														<span class="kt-nav__link-text">English</span>
													</a>
												</li>
												<li class="kt-nav__item">
													<a href="#" class="kt-nav__link">
														<span class="kt-nav__link-icon"><img src="${theme}/media/flags/016-spain.svg" alt="" /></span>
														<span class="kt-nav__link-text">Spanish</span>
													</a>
												</li>
												<li class="kt-nav__item">
													<a href="#" class="kt-nav__link">
														<span class="kt-nav__link-icon"><img src="${theme}/media/flags/017-germany.svg" alt="" /></span>
									...
									<div class="kt-header__topbar-item kt-header__topbar-item--user">
										<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,10px" aria-expanded="false">
											...
											<img class="kt-hidden" alt="Pic" src="${theme}/media/users/300_21.jpg">
										...
										<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
											...
											<!--begin: Head -->
											<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(${theme}/media/misc/bg-1.jpg)">
												<div class="kt-user-card__avatar">
													<img class="kt-hidden" alt="Pic" src="${theme}/media/users/300_25.jpg" />
													...
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--icon">
																<img src="${theme}/media/files/doc.svg" alt="">
															</div>
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--icon">
																<img src="${theme}/media/files/jpg.svg" alt="">
															</div>
															<a href="#" class="kt-widget4__title">
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--icon">
																<img src="${theme}/media/files/pdf.svg" alt="">
															</div>
															<a href="#" class="kt-widget4__title">
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--icon">
																<img src="${theme}/media/files/javascript.svg" alt="">
															</div>
															<a href="#" class="kt-widget4__title">
																Make JS Great Again
															</a>
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--icon">
																<img src="${theme}/media/files/zip.svg" alt="">
															</div>
															<a href="#" class="kt-widget4__title">
														...
														<div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
															<div class="kt-widget5">
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product27.jpg" alt="">
																		</div>
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product22.jpg" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Branding Mockup
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product15.jpg" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Awesome Mobile App
														...
														<div class="tab-pane" id="kt_widget5_tab2_content">
															<div class="kt-widget5">
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product10.jpg" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Branding Mockup
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product11.jpg" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Awesome Mobile App
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="${theme}/media//products/product6.jpg" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Great Logo Designn
													...
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--logo">
																<img src="${theme}/media/client-logos/logo5.png" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__title">
																	Trump Themes
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--logo">
																<img src="${theme}/media/client-logos/logo4.png" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__title">
																	StarBucks
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--logo">
																<img src="${theme}/media/client-logos/logo3.png" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__title">
																	Phyton
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--logo">
																<img src="${theme}/media/client-logos/logo2.png" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__title">
																	GreenMakers
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--logo">
																<img src="${theme}/media/client-logos/logo1.png" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__title">
																	FlyThemes
												...
												<div class="kt-portlet__body">
													<div class="kt-widget3">
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="${theme}/media/users/user1.jpg" alt="">
																</div>
														...
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="${theme}/media/users/user4.jpg" alt="">
																</div>
																<div class="kt-widget3__info">
																	<a href="#" class="kt-widget3__username">
																		Lebron King James
														...
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="${theme}/media/users/user5.jpg" alt="">
																</div>
																<div class="kt-widget3__info">
																	<a href="#" class="kt-widget3__username">
																		Deb Gibson
		...
		<!--begin:: Global Mandatory Vendors -->
		<script src="${theme}/jquery/dist/jquery.js" type="text/javascript"></script>
		<script src="${theme}/popper.js/dist/umd/popper.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
		<script src="${theme}/js-cookie/src/js.cookie.js" type="text/javascript"></script>
		<script src="${theme}/moment/min/moment.min.js" type="text/javascript"></script>
		<script src="${theme}/tooltip.js/dist/umd/tooltip.min.js" type="text/javascript"></script>
		<script src="${theme}/perfect-scrollbar/dist/perfect-scrollbar.js" type="text/javascript"></script>
		<script src="${theme}/sticky-js/dist/sticky.min.js" type="text/javascript"></script>
		<script src="${theme}/wnumb/wNumb.js" type="text/javascript"></script>

		<!--end:: Global Mandatory Vendors -->

		<!--begin:: Global Optional Vendors -->
		<script src="${theme}/jquery-form/dist/jquery.form.min.js" type="text/javascript"></script>
		<script src="${theme}/block-ui/jquery.blockUI.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/bootstrap-datepicker/init.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-datetime-picker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/bootstrap-timepicker/init.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-maxlength/src/bootstrap-maxlength.js" type="text/javascript"></script>
		<script src="${theme}/vendors/bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-select/dist/js/bootstrap-select.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-switch/dist/js/bootstrap-switch.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/bootstrap-switch/init.js" type="text/javascript"></script>
		<script src="${theme}/select2/dist/js/select2.full.js" type="text/javascript"></script>
		<script src="${theme}/ion-rangeslider/js/ion.rangeSlider.js" type="text/javascript"></script>
		<script src="${theme}/typeahead.js/dist/typeahead.bundle.js" type="text/javascript"></script>
		<script src="${theme}/handlebars/dist/handlebars.js" type="text/javascript"></script>
		<script src="${theme}/inputmask/dist/jquery.inputmask.bundle.js" type="text/javascript"></script>
		<script src="${theme}/inputmask/dist/inputmask/inputmask.date.extensions.js" type="text/javascript"></script>
		<script src="${theme}/inputmask/dist/inputmask/inputmask.numeric.extensions.js" type="text/javascript"></script>
		<script src="${theme}/nouislider/distribute/nouislider.js" type="text/javascript"></script>
		<script src="${theme}/owl.carousel/dist/owl.carousel.js" type="text/javascript"></script>
		<script src="${theme}/autosize/dist/autosize.js" type="text/javascript"></script>
		<script src="${theme}/clipboard/dist/clipboard.min.js" type="text/javascript"></script>
		<script src="${theme}/dropzone/dist/dropzone.js" type="text/javascript"></script>
		<script src="${theme}/summernote/dist/summernote.js" type="text/javascript"></script>
		<script src="${theme}/markdown/lib/markdown.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-markdown/js/bootstrap-markdown.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/bootstrap-markdown/init.js" type="text/javascript"></script>
		<script src="${theme}/bootstrap-notify/bootstrap-notify.min.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/bootstrap-notify/init.js" type="text/javascript"></script>
		<script src="${theme}/jquery-validation/dist/jquery.validate.js" type="text/javascript"></script>
		<script src="${theme}/jquery-validation/dist/additional-methods.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/jquery-validation/init.js" type="text/javascript"></script>
		<script src="${theme}/toastr/build/toastr.min.js" type="text/javascript"></script>
		<script src="${theme}/raphael/raphael.js" type="text/javascript"></script>
		<script src="${theme}/morris.js/morris.js" type="text/javascript"></script>
		<script src="${theme}/chart.js/dist/Chart.bundle.js" type="text/javascript"></script>
		<script src="${theme}/vendors/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js" type="text/javascript"></script>
		<script src="${theme}/vendors/jquery-idletimer/idle-timer.min.js" type="text/javascript"></script>
		<script src="${theme}/waypoints/lib/jquery.waypoints.js" type="text/javascript"></script>
		<script src="${theme}/counterup/jquery.counterup.js" type="text/javascript"></script>
		<script src="${theme}/es6-promise-polyfill/promise.min.js" type="text/javascript"></script>
		<script src="${theme}/sweetalert2/dist/sweetalert2.min.js" type="text/javascript"></script>
		<script src="${theme}/components/vendors/sweetalert2/init.js" type="text/javascript"></script>
		<script src="${theme}/jquery.repeater/src/lib.js" type="text/javascript"></script>
		<script src="${theme}/jquery.repeater/src/jquery.input.js" type="text/javascript"></script>
		<script src="${theme}/jquery.repeater/src/repeater.js" type="text/javascript"></script>
		<script src="${theme}/dompurify/dist/purify.js" type="text/javascript"></script>

		<!--end:: Global Optional Vendors -->

		<!--begin::Global Theme Bundle(used by all pages) -->
		<script src="${theme}/demo/demo2/base/scripts.bundle.js" type="text/javascript"></script>

		<!--end::Global Theme Bundle -->

		<!--begin::Page Vendors(used by this page) -->
		<script src="${theme}/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
		<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script>
		<script src="${theme}/gmaps/gmaps.js" type="text/javascript"></script>

		<!--end::Page Vendors -->

		<!--begin::Page Scripts(used by this page) -->
		<script src="${theme}/app/custom/general/dashboard.js" type="text/javascript"></script>
